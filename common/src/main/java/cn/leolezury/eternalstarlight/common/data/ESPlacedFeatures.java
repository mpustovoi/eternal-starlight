...
public class ESPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> HAZE_ICE_REDSTONE_ORE = create("haze_ice_redstone_ore");
	...
	public static final ResourceKey<PlacedFeature> ETERNAL_ICE_SALTPETER_ORE = create("eternal_ice_saltpeter_ore");
	public static final ResourceKey<PlacedFeature> HAZE_ICE_SALTPETER_ORE = create("haze_ice_saltpeter_ore");
	...
	public static final ResourceKey<PlacedFeature> ETERNAL_ICE_ATALPHAITE_ORE = create("eternal_ice_atalphaite_ore");
	public static final ResourceKey<PlacedFeature> HAZE_ICE_ATALPHAITE_ORE = create("haze_ice_atalphaite_ore");
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(context, HAZE_ICE_REDSTONE_ORE, configuredFeatures.getOrThrow(ESConfiguredFeatures.HAZE_ICE_REDSTONE_ORE), commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(0))));
		...
		PlacementUtils.register(context, ETERNAL_ICE_SALTPETER_ORE, configuredFeatures.getOrThrow(ESConfiguredFeatures.ETERNAL_ICE_SALTPETER_ORE), commonOrePlacement(18, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.top())));
		PlacementUtils.register(context, HAZE_ICE_SALTPETER_ORE, configuredFeatures.getOrThrow(ESConfiguredFeatures.HAZE_ICE_SALTPETER_ORE), commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(0))));
		...
		PlacementUtils.register(context, ETERNAL_ICE_ATALPHAITE_ORE, configuredFeatures.getOrThrow(ESConfiguredFeatures.ETERNAL_ICE_ATALPHAITE_ORE), commonOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.top())));
		PlacementUtils.register(context, HAZE_ICE_ATALPHAITE_ORE, configuredFeatures.getOrThrow(ESConfiguredFeatures.HAZE_ICE_ATALPHAITE_ORE), commonOrePlacement(5, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(0))));
