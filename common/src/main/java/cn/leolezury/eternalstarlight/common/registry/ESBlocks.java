...
public class ESBlocks {
	...
	public static final RegistryObject<Block, SimpleMultifaceBlock> CAVE_MOSS_VEIN = BLOCKS.register("cave_moss_vein", () -> new SimpleMultifaceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLOW_LICHEN).lightLevel(state -> 7).mapColor(MapColor.PLANT)));
	...
	// voidstone
	public static final RegistryObject<Block, Block> VOIDSTONE = BLOCKS.register("voidstone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, Block> COBBLED_VOIDSTONE = BLOCKS.register("cobbled_voidstone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLESTONE).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, SlabBlock> COBBLED_VOIDSTONE_SLAB = BLOCKS.register("cobbled_voidstone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, StairBlock> COBBLED_VOIDSTONE_STAIRS = BLOCKS.register("cobbled_voidstone_stairs", () -> new StairBlock(COBBLED_VOIDSTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, WallBlock> COBBLED_VOIDSTONE_WALL = BLOCKS.register("cobbled_voidstone_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, Block> VOIDSTONE_BRICKS = BLOCKS.register("voidstone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, SlabBlock> VOIDSTONE_BRICK_SLAB = BLOCKS.register("voidstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, StairBlock> VOIDSTONE_BRICK_STAIRS = BLOCKS.register("voidstone_brick_stairs", () -> new StairBlock(VOIDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, WallBlock> VOIDSTONE_BRICK_WALL = BLOCKS.register("voidstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, Block> POLISHED_VOIDSTONE = BLOCKS.register("polished_voidstone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, SlabBlock> POLISHED_VOIDSTONE_SLAB = BLOCKS.register("polished_voidstone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, StairBlock> POLISHED_VOIDSTONE_STAIRS = BLOCKS.register("polished_voidstone_stairs", () -> new StairBlock(POLISHED_VOIDSTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, WallBlock> POLISHED_VOIDSTONE_WALL = BLOCKS.register("polished_voidstone_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, Block> VOIDSTONE_TILES = BLOCKS.register("voidstone_tiles", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, SlabBlock> VOIDSTONE_TILE_SLAB = BLOCKS.register("voidstone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, StairBlock> VOIDSTONE_TILE_STAIRS = BLOCKS.register("voidstone_tile_stairs", () -> new StairBlock(VOIDSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, WallBlock> VOIDSTONE_TILE_WALL = BLOCKS.register("voidstone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, Block> CHISELED_VOIDSTONE = BLOCKS.register("chiseled_voidstone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).mapColor(MapColor.COLOR_BLACK)));
	public static final RegistryObject<Block, Block> GLOWING_VOIDSTONE = BLOCKS.register("glowing_voidstone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).mapColor(MapColor.COLOR_BLACK).lightLevel(state -> 10)));
	...
	public static final RegistryObject<Block, Block> RADIANITE_BRICKS = BLOCKS.register("radianite_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).mapColor(DyeColor.WHITE)));
	public static final RegistryObject<Block, SlabBlock> RADIANITE_BRICK_SLAB = BLOCKS.register("radianite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB).mapColor(DyeColor.WHITE)));
	public static final RegistryObject<Block, StairBlock> RADIANITE_BRICK_STAIRS = BLOCKS.register("radianite_brick_stairs", () -> new StairBlock(RADIANITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS).mapColor(DyeColor.WHITE)));
	public static final RegistryObject<Block, WallBlock> RADIANITE_BRICK_WALL = BLOCKS.register("radianite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL).mapColor(DyeColor.WHITE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> OXIDIZED_GOLEM_STEEL_BLOCK = BLOCKS.register("oxidized_golem_steel_block", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelSlabBlock> GOLEM_STEEL_SLAB = BLOCKS.register("golem_steel_slab", () -> new WeatheringGolemSteelSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, WeatheringGolemSteelSlabBlock> OXIDIZED_GOLEM_STEEL_SLAB = BLOCKS.register("oxidized_golem_steel_slab", () -> new WeatheringGolemSteelSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelStairBlock> GOLEM_STEEL_STAIRS = BLOCKS.register("golem_steel_stairs", () -> new WeatheringGolemSteelStairBlock(GOLEM_STEEL_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_STAIRS).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, WeatheringGolemSteelStairBlock> OXIDIZED_GOLEM_STEEL_STAIRS = BLOCKS.register("oxidized_golem_steel_stairs", () -> new WeatheringGolemSteelStairBlock(OXIDIZED_GOLEM_STEEL_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> GOLEM_STEEL_TILES = BLOCKS.register("golem_steel_tiles", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> OXIDIZED_GOLEM_STEEL_TILES = BLOCKS.register("oxidized_golem_steel_tiles", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelSlabBlock> GOLEM_STEEL_TILE_SLAB = BLOCKS.register("golem_steel_tile_slab", () -> new WeatheringGolemSteelSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, WeatheringGolemSteelSlabBlock> OXIDIZED_GOLEM_STEEL_TILE_SLAB = BLOCKS.register("oxidized_golem_steel_tile_slab", () -> new WeatheringGolemSteelSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_SLAB).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelStairBlock> GOLEM_STEEL_TILE_STAIRS = BLOCKS.register("golem_steel_tile_stairs", () -> new WeatheringGolemSteelStairBlock(GOLEM_STEEL_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.CUT_COPPER_STAIRS).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelGrateBlock> GOLEM_STEEL_GRATE = BLOCKS.register("golem_steel_grate", () -> new WeatheringGolemSteelGrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_GRATE).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, WeatheringGolemSteelGrateBlock> OXIDIZED_GOLEM_STEEL_GRATE = BLOCKS.register("oxidized_golem_steel_grate", () -> new WeatheringGolemSteelGrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_GRATE).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelPillarBlock> GOLEM_STEEL_PILLAR = BLOCKS.register("golem_steel_pillar", () -> new WeatheringGolemSteelPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE).lightLevel(state -> 10)));
	public static final RegistryObject<Block, WeatheringGolemSteelPillarBlock> OXIDIZED_GOLEM_STEEL_PILLAR = BLOCKS.register("oxidized_golem_steel_pillar", () -> new WeatheringGolemSteelPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE).lightLevel(state -> 10)));
	public static final RegistryObject<Block, WeatheringGolemSteelBarsBlock> GOLEM_STEEL_BARS = BLOCKS.register("golem_steel_bars", () -> new WeatheringGolemSteelBarsBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BARS).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, WeatheringGolemSteelBarsBlock> OXIDIZED_GOLEM_STEEL_BARS = BLOCKS.register("oxidized_golem_steel_bars", () -> new WeatheringGolemSteelBarsBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BARS).mapColor(MapColor.COLOR_GRAY)));
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> CHISELED_GOLEM_STEEL_BLOCK = BLOCKS.register("chiseled_golem_steel_block", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, RedstoneDoomedenKeyholeBlock> REDSTONE_DOOMEDEN_KEYHOLE = BLOCKS.register("redstone_doomeden_keyhole", () -> new RedstoneDoomedenKeyholeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BRICKS).mapColor(MapColor.COLOR_GREEN)));
	...
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_AUREATE_FLOWER = BLOCKS.register("potted_aureate_flower", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, AUREATE_FLOWER, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_YELLOW)));
	...
	public static final RegistryObject<Block, ESShortBushBlock> CRESCENT_GRASS = BLOCKS.register("crescent_grass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_CRESCENT_GRASS = BLOCKS.register("potted_crescent_grass", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, CRESCENT_GRASS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, ESShortBushBlock> GLOWING_CRESCENT_GRASS = BLOCKS.register("glowing_crescent_grass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE).lightLevel(state -> 15)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_GLOWING_CRESCENT_GRASS = BLOCKS.register("potted_glowing_crescent_grass", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, GLOWING_CRESCENT_GRASS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_BLUE).lightLevel(state -> 15)));
	public static final RegistryObject<Block, ESShortBushBlock> PARASOL_GRASS = BLOCKS.register("parasol_grass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_PARASOL_GRASS = BLOCKS.register("potted_parasol_grass", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, PARASOL_GRASS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, ESShortBushBlock> GLOWING_PARASOL_GRASS = BLOCKS.register("glowing_parasol_grass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE).lightLevel(state -> 15)));
	...
	public static final RegistryObject<Block, ESShortBushBlock> LUNAR_BUSH = BLOCKS.register("lunar_bush", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE)));
	public static final RegistryObject<Block, ESShortBushBlock> GLOWING_LUNAR_BUSH = BLOCKS.register("glowing_lunar_bush", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE).lightLevel(state -> 15)));
	...
	public static final RegistryObject<Block, ESShortBushBlock> WHISPERBLOOM = BLOCKS.register("whisperbloom", () -> new ESShortBushBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_PINK)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_WHISPERBLOOM = BLOCKS.register("potted_whisperbloom", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, WHISPERBLOOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_PINK)));
	public static final RegistryObject<Block, ESShortBushBlock> GLADESPIKE = BLOCKS.register("gladespike", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_YELLOW)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_GLADESPIKE = BLOCKS.register("potted_gladespike", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, GLADESPIKE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_YELLOW)));
	public static final RegistryObject<Block, ESShortBushBlock> VIVIDSTALK = BLOCKS.register("vividstalk", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_RED)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_VIVIDSTALK = BLOCKS.register("potted_vividstalk", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, VIVIDSTALK, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_RED)));
	...
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_BOULDERSHROOM = BLOCKS.register("potted_bouldershroom", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, BOULDERSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_PINK)));
	public static final RegistryObject<Block, HugeMushroomBlock> BOULDERSHROOM_BLOCK = BLOCKS.register("bouldershroom_block", () -> new HugeMushroomBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_MUSHROOM_BLOCK).mapColor(MapColor.COLOR_PINK).strength(0.2F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block, ESShortBushBlock> FANTAFERN = BLOCKS.register("fantafern", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_PURPLE).lightLevel(state -> 15)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_FANTAFERN = BLOCKS.register("potted_fantafern", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, FANTAFERN, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_PURPLE).lightLevel(state -> 15)));
	public static final RegistryObject<Block, ESShortBushBlock> GREEN_FANTAFERN = BLOCKS.register("green_fantafern", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_GREEN)));
	public static final RegistryObject<Block, FlowerPotBlock> POTTED_GREEN_FANTAFERN = BLOCKS.register("potted_green_fantafern", () -> ESPlatform.INSTANCE.createFlowerPot(() -> (FlowerPotBlock) Blocks.FLOWER_POT, GREEN_FANTAFERN, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_GREEN)));
	public static final RegistryObject<Block, ESShortBushBlock> FANTAGRASS = BLOCKS.register("fantagrass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_PURPLE).lightLevel(state -> 15)));
	public static final RegistryObject<Block, ESShortBushBlock> GREEN_FANTAGRASS = BLOCKS.register("green_fantagrass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_GREEN)));
	...
	public static final RegistryObject<Block, ESShortBushBlock> SCARLET_GRASS = BLOCKS.register("scarlet_grass", () -> new ESShortBushBlock(13, BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_RED)));
	...
	public static final RegistryObject<Block, CrestPotBlock> CREST_POT = BLOCKS.register("crest_pot", () -> new CrestPotBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DECORATED_POT).mapColor(MapColor.COLOR_BLACK).lightLevel(state -> 2)));
