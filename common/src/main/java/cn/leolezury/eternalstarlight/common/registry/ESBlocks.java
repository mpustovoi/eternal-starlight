...
public class ESBlocks {
	...
	public static final RegistryObject<Block, VelvetumossVilliBlock> VELVETUMOSS_VILLI = register("velvetumoss_villi", properties -> new VelvetumossVilliBlock(VELVETUMOSS.asHolder(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.MOSS_BLOCK).randomTicks());
	...
	public static final RegistryObject<Block, VelvetumossVilliBlock> RED_VELVETUMOSS_VILLI = register("red_velvetumoss_villi", properties -> new VelvetumossVilliBlock(RED_VELVETUMOSS.asHolder(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.MOSS_BLOCK).randomTicks().mapColor(MapColor.COLOR_RED));
	...
	public static final RegistryObject<Block, TorreyaVinesBlock> TORREYA_VINES = register("torreya_vines", TorreyaVinesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CAVE_VINES).lightLevel(state -> 15).mapColor(MapColor.COLOR_BLACK));
	...
	// lunar monstrosity
	public static final RegistryObject<Block, ShadegrieveBlock> SHADEGRIEVE = register("shadegrieve", ShadegrieveBlock::new, BlockBehaviour.Properties.of().strength(25F).sound(SoundType.AZALEA_LEAVES).mapColor(MapColor.COLOR_PURPLE));
	public static final RegistryObject<Block, ShadegrieveBlock> BLOOMING_SHADEGRIEVE = register("blooming_shadegrieve", ShadegrieveBlock::new, BlockBehaviour.Properties.of().strength(25F).sound(SoundType.AZALEA_LEAVES).mapColor(MapColor.COLOR_PURPLE));
