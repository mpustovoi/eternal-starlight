...
public class ESWeathers {
	...
	public static final RegistryObject<AbstractWeather, MeteorShowerWeather> METEOR_SHOWER = WEATHERS.register("meteor_shower", () -> new MeteorShowerWeather(new AbstractWeather.Properties(UniformInt.of(600, 800), UniformInt.of(24000, 180000))));
